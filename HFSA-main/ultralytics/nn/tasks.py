...
class SemanticSegmentationModel(DetectionModel):
    """YOLO semantic segmentation model with dense per-pixel masks."""

    def __init__(self, cfg="yolov12-semseg.yaml", ch=3, nc=None, verbose=True):
        """Initialize semantic segmentation model with given config and parameters."""
        super().__init__(cfg=cfg, ch=ch, nc=nc, verbose=verbose)
    ...
    def init_criterion(self):
        """Initialize the loss criterion for dense semantic segmentation."""
